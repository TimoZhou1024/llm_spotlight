...
- Keep your reasoning and statement strictly under 500 words.
```json
{
...
## React
REACT = PREFIX + DEBATE_SO_FAR_THIS_ROUND + """INSTRUCTIONS:
- You are speaking next in the debate as {{name}} the {{role}}.
- Your thoughts on speaking next: {{last_thought}}

Your Task:
- You are about to make the following statement: 
    {{statement}}
- Before you say it, carefully consider:
    1. How each player might interpret your statement.
    2. How they might use your words against you.
- Answer the above two questions first, then revise your statement if necessary to maximize your chances of winning.
- Keep your reasoning and statement strictly under 500 words.

```json
{
  "reasoning": "string", // Your answers to the above two questions and your internal reasoning.
  "say": "string" // Your final public statement in the debate.
}
"""
